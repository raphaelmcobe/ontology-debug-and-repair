 ...
 */
public class ResinaBlackBoxRemainderExpansionStrategy extends BlackBoxRemainderExpansionStrategy {

	public ResinaBlackBoxRemainderExpansionStrategy(OWLOntologyManager manager) {
		super(manager);
	}
